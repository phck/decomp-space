...
\thanks{This work was supported by a grant from the Simons Foundation (\#850849).}
...
This paper can be read in multiple ways.
...
In this section we discuss the following fundamental result from \cite{Feller_et_al:E2SSU}.\phnote{Mention here that it was known much earlier that decomposition spaces and unital 2-Segal spaces were the same.}
