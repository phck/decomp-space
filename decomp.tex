...
We will give an account of this result in \cref{sec 2-Segl decomp}, following \cite{GKT1,Feller_et_al:E2SSU}.
...
For a reader working with simplicial sets rather than simplicial spaces, these will just be ordinary pullbacks.\footnote{When working under option \eqref{item gen cat} from \cref{sec ways to read}, one will use ordinary pullbacks in $C$, and when working under option \eqref{item gen inf cat} one will use $(\infty,1)$-categorical pullbacks.}
\end{convention}
