...
\phnoteil{Write about other categories with active-inert factorization systems. \cite{Burkin:TACOSC,Berger:MCO,Contreras_et_al:FCPBS}}
\end{diversion}
...
In this section we discuss the following fundamental result. % from \cite{Feller_et_al:E2SSU}.
\phnote{Mention \cite{Feller_et_al:E2SSU} and that it was known much earlier that decomposition spaces and unital 2-Segal spaces were the same.}
...
% We will use the pasting law to establish that each Segal space is also a 2-Segal space.
